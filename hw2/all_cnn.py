...
def all_cnn_module():
    ...
    layers = [
        nn.Dropout(p=0.2),
        nn.Conv2d(3, 96, 3, stride=1, padding=1, bias=False),
        nn.ReLU(),
        ...
        nn.ReLU(),
        nn.Dropout(p=0.5),
        nn.Conv2d(192, 192, 3, stride=1, padding=0, bias=False),
        nn.ReLU(),
        nn.Conv2d(192, 192, 1, stride=1, padding=0, bias=False),
        nn.ReLU(),
        nn.Conv2d(192, 10, 1, stride=1, padding=0, bias=False),
        nn.ReLU(),
        nn.AvgPool2d(6),
        Flatten()
    ]
